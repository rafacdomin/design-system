...
Para cada componente, crie sempre:

- **No pacote core** (na pasta do componente): `.tsx`, `.test.tsx`, `.module.scss`, `index.ts`
- **No pacote docs** (na pasta `packages/docs/src/stories/`): `ComponentName.stories.tsx`
